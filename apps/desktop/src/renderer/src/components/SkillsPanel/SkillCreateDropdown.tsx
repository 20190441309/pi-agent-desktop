            ...
            {open && (
                <div className="absolute right-0 top-full mt-1 w-72 bg-white border border-[#e5e5e5] rounded-lg shadow-lg z-10 py-1">
                    ...
                    >
                        <span className={optionIconClasses} aria-hidden="true">
                            <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.6} d="M8 10h8M8 14h5m8-2a8 8 0 1 1-4.9-7.37L21 4l-1.2 4.2A7.96 7.96 0 0 1 21 12z" />
                            </svg>
                        </span>
                        <div>
                    ...
                    >
                        <span className={optionIconClasses} aria-hidden="true">
                            <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.6} d="M16.86 4.49 19.5 7.14 8.5 18.14 4 19.5l1.36-4.5 11.5-10.51z" />
                            </svg>
                        </span>
                        <div>
